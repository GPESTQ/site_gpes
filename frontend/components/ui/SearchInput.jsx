...
const SearchInput = ({ value, onChange, placeholder = "Buscar...", className = "" }) => (
    <div className="relative">
        ...
        <input
            ...
            className={`w-96 bg-neutral-50 rounded-lg border border-neutral-400 pl-4 pr-12 py-3 text-neutral-950 font-sans placeholder:text-neutral-400 text-sm ${className}`}
        />
    </div>
);
